"""Configuration for the single-stage inverted-pendulum forward-dynamics MPC demo."""
...
# Pole inertia about the hinge axis y.
...
# Control regularization. In forward-dynamics MPC, acceleration is NOT a
# decision variable, so there is no acceleration regularization term.
R_FORCE = 0.008
